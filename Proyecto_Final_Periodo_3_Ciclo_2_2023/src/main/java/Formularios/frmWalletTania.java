...
public class frmWalletTania extends javax.swing.JFrame implements Runnable 
{
    ...
    private void initComponents() {
        ...
        setPreferredSize(new java.awt.Dimension(344, 390));

        labelBalance.setText("₿ :");

        jLabel2.setText("Wallet de: Tania");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmWalletTania.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmWalletTania().setVisible(true);
            }
        });
    }
